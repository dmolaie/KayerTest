...
return array(
    ...
    */
    'attributes' => array(
        ...
        "first_name_owner" => "نام صاحب کسب کار",
        "last_name_owner" => "نام خانوادگی صاحب کسب و کار",
        "password" => "رمز عبور",
        ...
        "sub_type" => "نوع",
        "image.0" => "تصویر",
        'user_id' => "فیلد انتخاب کاربر الزامی است",
        'location' => "فیلد موقعیت جغرافیایی الزامی است",
