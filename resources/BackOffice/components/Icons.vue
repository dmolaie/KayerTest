<template>
    <svg xmlns="http://www.w3.org/2000/svg" class="none pointer-event-none">
        <symbol viewBox="0 0 24 24" id="icon--image">
            ...
            <path d="M16.916 8.71A1.027 1.027 0 0016 8.158a1.007 1.007 0 00-.892.586l-1.558 3.434a.249.249 0 01-.422.053l-.82-1.024a1 1 0 00-.813-.376 1.007 1.007 0 00-.787.426L7.59 15.71a.5.5 0 00.41.79h12a.5.5 0 00.425-.237.5.5 0 00.022-.486z"/>
