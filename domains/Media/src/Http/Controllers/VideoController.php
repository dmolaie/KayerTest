...
use Domains\Media\Http\Requests\Video\VideoListForAdminRequest;
use Domains\Media\Http\Requests\Video\ChangeVideoStatusRequest;
use Domains\Media\Http\Requests\Video\CreateVideoRequest;
use Domains\Media\Http\Requests\Video\EditVideoRequest;
use Domains\Media\Services\MediaService;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\Response;

class VideoController extends EhdaBaseController
{
    ...
    public function create(CreateVideoRequest $request, MediaInfoPresenter $mediaInfoPresenter)
    {
    ...
    public function edit(EditVideoRequest $request, MediaInfoPresenter $mediaInfoPresenter)
    {
        try{
    ...
    public function getListForAdmin(
        VideoListForAdminRequest $request,
    ...
    public function changeStatus(ChangeVideoStatusRequest $request, MediaInfoPresenter $mediaInfoPresenter)
    {
        try {
