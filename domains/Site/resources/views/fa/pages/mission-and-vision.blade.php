        ...
        <div class="miv-page i-page">
            <div class="container sm:p-0">
                ...
                <div class="inner-box inner-box--white">
                    <p class="i-page__sub-title text-blue-800 font-lg font-bold cursor-default m-b-26 sm:font-sm">
                        ماموریت :
                    </p>
                    <p class="i-page__text md:font-sm text-bayoux font-base text-right m-b-70 text-justify sm:font-base">
                    ...
                    <p class="relative i-page__text md:font-sm text-bayoux font-base text-right m-b-70 text-justify sm:font-base">
