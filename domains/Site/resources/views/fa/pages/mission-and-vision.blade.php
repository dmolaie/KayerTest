        ...
        <div class="miv-page i-page">
            <div class="container">
                ...
                <div class="inner-box inner-box--white">
                    <p class="i-page__sub-title text-blue-800 font-lg font-bold cursor-default m-b-26">
                        ماموریت :
                    </p>
                    <p class="i-page__text md:font-sm text-bayoux font-base text-right m-b-70 text-justify">
                    ...
                    <p class="relative i-page__text md:font-sm text-bayoux font-base text-right m-b-70 text-justify">
