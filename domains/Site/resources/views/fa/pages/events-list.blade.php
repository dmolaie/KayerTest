        ...
        <div class="container md:p-0">
            <div class="inner-box inner-box--blue flex items-start text-right md:flex-col">
                        ...
                        <div class="i-page__panel_header w-full md:border-0">
                            <label class="i-page__panel_label flex items-center w-full border border-solid rounded">
                                <input type="text"
                                       ...
                                       placeholder="جستجو در رویدادها" autocomplete="off"
                                       value="{{ $searchValue }}"
                                />
                            </label>
                        </div>
                ...
                <div class="w-full">
                    ...
                    @endforeach
                    {!! $events->appends(Request::capture()->except('page'))->render() !!}
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script src="{{secure_asset('js/site/vendors~gallery-audio~gallery-images~home~news_list~news_show.js?v=c1590828349')}}" defer></script>
    <script src="{{secure_asset('js/site/news_list.js?v=c1590828349')}}" defer></script>
@endsection
