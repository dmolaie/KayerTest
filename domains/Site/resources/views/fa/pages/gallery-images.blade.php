@extends('fa.template.master')
                                ...
                                <div class="gai-page__modal_body w-full">
                                    <div class="relative max-w-full h-full overflow-x-hidden">
                                        ...
                                        >
                                            ...
                                            >
                                                <path transform="rotate(180 5 8)" fill="#fff"
                                                      d="M3.36 8.003l6.368-5.985a.842.842 0 0 0 0-1.238L9.17.256A.954.954 0 0 0 8.512 0c-.25 0-.483.09-.659.256L.272 7.382a.842.842 0 0 0 0 1.243l7.574 7.12a.954.954 0 0 0 .659.255c.25 0 .483-.09.658-.256l.558-.524a.84.84 0 0 0 0-1.238l-6.36-5.979z"
                                                />
                                            </svg>
                                        </button>
                                        <button class="gai-page__carousel-btn gai-page__carousel-btn--left absolute z-20"
                                                title="بعدی"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 10 16"
                                                 class="h-full object-contain"
                                            >
                                                <path fill="#fff" class="h-full object-contain"
                                                      d="M3.36 8.003l6.368-5.985a.842.842 0 0 0 0-1.238L9.17.256A.954.954 0 0 0 8.512 0c-.25 0-.483.09-.659.256L.272 7.382a.842.842 0 0 0 0 1.243l7.574 7.12a.954.954 0 0 0 .659.255c.25 0 .483-.09.658-.256l.558-.524a.84.84 0 0 0 0-1.238l-6.36-5.979z"
                                                />
                                            </svg>
                                        </button>
    ...
    @section('scripts')
        <script src="{{asset('js/site/vendors~gallery-images~home~news_list~news_show.js')}}" defer></script>
