...
return array(
    ...
    */
    'attributes'            => [
        ...
        "event_start_register_date" => "تاریخ شروع ثبت نام رویداد",
        "event_end_register_date"   => "تاریخ پایان ثبت نام رویداد",
        "source_link_text"          => "منبع متنی",
        "source_link_image"         => "منبع تصویری",
        "source_link_video"         => "منبع ویدیویی",
        "province_id"               => "دامنه",
        "language"                  => "زبان",
