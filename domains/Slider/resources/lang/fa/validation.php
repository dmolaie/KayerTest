...
return array(
    ...
    */
    'attributes'            => [
        ...
        "province_id"        => "دامنه",
        "language"           => "زبان",
        "parent_id"          => "اسلایدر مرتبط",
        "status"             => "وضعیت اسلایدر",
        "editor_id"          => "مالک اسلایدر",
        "publish_date_end"   => "تاریخ شروع ایجاد اسلایدر",
        "publish_date_start" => "تاریخ پایان ایجاد اسلایدر",
        "slider_id"            => "شماره اسلایدر",
        "status"             => "وضعیت اسلایدر",
        "slug"               => "اسلاگ اسلایدر",
    ],
