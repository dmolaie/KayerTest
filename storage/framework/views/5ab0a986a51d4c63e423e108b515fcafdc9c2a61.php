    ...
    <div class="p-home">
        <div class="block w-full">
            <figure class="block w-full">
                <img src="<?php echo e(asset('/images/slider/image_slider--1.jpg')); ?>"
        ...
        <div class="link flex justify-center">
            <a href="<?php echo e(route('page.donation-card',config('app.locale'))); ?>"
               class="link__item link__item--green font-lg font-bold text-white text-center l:transition-background"
            >
                کارت اهدای عضو
            </a>
            <a href="<?php echo e(route('page.volunteers',config('app.locale'))); ?>"
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <a href=""
                                   class="info__cart relative block rounded-3 border border-solid bg-white w-full has-shadow">
                                    <figure class="info__cart_image block w-full m-0-auto">
                                        <img src="<?php echo e(asset('images/information/تاریخچه‌ی اهدا و پیوند.svg')); ?>"
                            ...
                            <div class="swiper-slide">
                                <a href=""
                                   class="info__cart relative block rounded-3 border border-solid bg-white w-full has-shadow">
                                    <figure class="info__cart_image block w-full m-0-auto">
                                        <img src="<?php echo e(asset('images/information/فرایند مرگ مغزی.svg')); ?>"
                                             alt="فرایند مرگ مغزی"
                                             class="block w-full h-full rounded object-contain"
                                        />
                                    </figure>
                            ...
                            <div class="swiper-slide">
                                <a href=""
                                   class="info__cart relative block rounded-3 border border-solid bg-white w-full has-shadow">
                                    <figure class="info__cart_image block w-full m-0-auto">
                                        <img src="<?php echo e(asset('images/information/مروری بر اهدای عضو.svg')); ?>"
                            ...
                            <div class="swiper-slide">
                                <a href=""
                                   class="info__cart relative block rounded-3 border border-solid bg-white w-full has-shadow">
                                    <figure class="info__cart_image block w-full m-0-auto">
                                        <img src="<?php echo e(asset('images/information/تخصیص عضو.svg')); ?>"
                                             alt="تخصیص عضو"
                                             class="block w-full h-full rounded object-contain"
                                        />
                                    </figure>
                            ...
                            <div class="swiper-slide">
                                <a href=""
                                   class="info__cart relative block rounded-3 border border-solid bg-white w-full has-shadow">
                                    <figure class="info__cart_image block w-full m-0-auto">
                                        <img src="<?php echo e(asset('images/information/اهدای عضو در سایر کشورها.svg')); ?>"
                            ...
                            <div class="swiper-slide">
                                <a href=""
                                   class="info__cart relative block rounded-3 border border-solid bg-white w-full has-shadow">
                                    <figure class="info__cart_image block w-full m-0-auto">
                                        <img src="<?php echo e(asset('images/information/اهدای عضو و مذهب.svg')); ?>"
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('js/site/vendors~home~news_list~news_show.js')); ?>" defer></script>
    <script src="<?php echo e(asset('js/site/home.js')); ?>" defer></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('fa.template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/domains/Site/src/../resources/views/fa/index.blade.php ENDPATH**/ ?>