                ...
                <div class="flex items-start m-b-85 md:flex-col-reverse">
                    ...
                    <div class="l:w-280 l:m-r-45 md:w-100 md:m-b-20">
                        <figure class="block w-full m-b-10 has-skeleton">
                            <img src=""
                                 data-src="<?php echo e(asset('images/3W6A0137.jpg')); ?>"
                                 alt=""
                        ...
                        <figure class="block w-full m-b-10 has-skeleton">
                            <img src=""
                                 data-src="<?php echo e(asset('images/اکی-ساختمان.jpg')); ?>"
                                 alt=""
                                 class="history-page__cover block w-full h-full rounded-3 object-cover"
                            />
                        </figure>
                        <figure class="block w-full has-skeleton">
                            <img src=""
                                 data-src="<?php echo e(asset('images/3W6A0155.jpg')); ?>"
                                 alt=""
                                 class="history-page__cover block w-full h-full rounded-3 object-cover"
                            />
                        </figure>
...
<?php echo $__env->make('fa.template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/domains/Site/src/../resources/views/fa/pages/history.blade.php ENDPATH**/ ?>